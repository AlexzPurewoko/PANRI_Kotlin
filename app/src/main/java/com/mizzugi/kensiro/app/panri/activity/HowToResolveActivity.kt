...
import kotlinx.android.synthetic.main.activity_how_to_resolve.*
import kotlinx.coroutines.GlobalScope
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class HowToResolveActivity : AppCompatActivity(), OnRequestDialog,
    ItemClickSupport.OnItemClickListener, ShowResultDiagnoseFragment.OnResultCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_how_to_resolve)
    ...
    override fun onItemClicked(recyclerView: RecyclerView, position: Int, v: View) {
        ...
        farmerFragment.update(getText(R.string.acthowto_string_speechfarmer_2).toString())
    }
    ...
    override fun onFinal(fragment: Fragment) {
        ...
        farmerFragment.update(getText(R.string.acthowto_string_speechfarmer_1).toString())
    }
    ...
    private fun display(savedState: Bundle?) {
        ...
        GlobalScope.launch {
            ...
            resultFragment.currentBtnCase = ShowResultDiagnoseViewModel.CurrentBtnCondition.CASE_2
        }
    }
